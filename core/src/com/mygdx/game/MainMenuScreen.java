...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen(MyGdxGame Game){
        ...
        setting= new Button(new Sprite(new Texture(Gdx.files.internal("image/menu/nastroyki144.png"))), (int)(2.5f / 6 * Gdx.graphics.getWidth()), (int)(1.0f / 3 * Gdx.graphics.getHeight()));
        exit = new Button(new Sprite(new Texture(Gdx.files.internal("image/menu/vykhod144.png"))), (int)(3.5f / 6 * Gdx.graphics.getWidth()), (int)(1.0f / 3 * Gdx.graphics.getHeight()));
